...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <applicationVisibilities>
        <application>huisooJeong</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.ProductList__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.acceptContents__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.acceptDate__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.acceptUserId__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.authDate__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.authUserId__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.oppositContents__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.responseContents__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.responseDate__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.responseUserId__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <flowAccesses>
        ...
        <flow>approvalReceiptFlow</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>responseUserFlow</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>responseUserId_setting_flow</flow>
    </flowAccesses>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>AppointmentInvitation-약속 초대 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>CaseMilestone-사례 중대 사건 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ChangeRequest-변경 요청 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ContractLineItem-계약 행 항목 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>CustomObject1__c-민원 홈 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>EnhancedLetterhead-고급 레터헤드 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Entitlement-권리 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>EntityMilestone-개체 중대 사건 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Incident-사고 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Knowledge__kav-Knowledge 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Knowledge__kav-Knowledge 레이아웃</layout>
    ...
    <layoutAssignments>
        <layout>LiveAgentSession-Chat 세션 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>LiveChatTranscript-Chat 기록 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>LiveChatTranscriptActive-Chat 기록%28진행 중%29 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>LiveChatTranscriptEvent-Chat 기록 이벤트 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>LiveChatTranscriptWaiting-Chat 기록%28대기 중%29 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>LiveChatVisitor-Chat 방문자 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ServiceContract-서비스 계약 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>UserAlt-사용자 프로필 레이아웃</layout>
    </layoutAssignments>
    <layoutAssignments>
